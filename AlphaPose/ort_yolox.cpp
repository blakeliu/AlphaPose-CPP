...
Ort::Value OrtYoloX::transform(const cv::Mat &mat_rs)
{
...
void OrtYoloX::resize_unscale(const cv::Mat &mat, cv::Mat &mat_rs,
...
void OrtYoloX::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void OrtYoloX::generate_anchors(const int target_height,
...
void OrtYoloX::generate_bboxes(const YoloXScaleParams &scale_params,
                                    std::vector<types::Boxf> &bbox_collection,
...
void OrtYoloX::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
