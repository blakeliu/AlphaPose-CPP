...
int main0()
{
    ...
    // 加载模型
    // -dpm  ..\alpha_pose_models\FastestDet.param -dbm ..\alpha_pose_models\FastestDet.bin -ppm  -pj 26  -i pics\1.jpg -o pics\1-out.jpg 
    ncnn::Net net;
    net.load_param("../alpha_pose_models/FastestDet.param");
    net.load_model("../alpha_pose_models/FastestDet.bin");
    printf("ncnn model load sucess...\n");

    // 加载图片
    cv::Mat img = cv::imread("pics/1.jpg");
